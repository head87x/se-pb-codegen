...
const I18N = {
  de: {
    ...
    "header.expert":         "Experten",
    "exec.refresh_interval": "Aggregator-Refresh alle N Ticks",
    "exec.refresh_interval.help": "Aggregator-Listen (für „Alle Blöcke vom Typ\" und LCD-Aggregator-Widgets) werden normal jeden Tick neu gesucht. Höher = sparsamer, aber neue Blöcke werden bis zu N Ticks später erkannt. SE-Wiki empfiehlt 100+.",
    "exec.chunk_size":       "Blöcke pro Tick (Coroutine-Chunk)",
    "exec.chunk_size.help":  "Wie viele Blöcke pro Tick im Aggregator-Coroutine-Modus verarbeitet werden. Default 50. Kleiner = mehr Ticks bis das Skript fertig ist, aber geringerer Druck auf das Tick-Budget.",
    "cond.paren_open":       "( öffnen",
    "cond.paren_close":      ") schließen",
    "cond.paren_open.title": "Klammer öffnen — vor dieser Bedingung",
    "cond.paren_close.title":"Klammer schließen — nach dieser Bedingung",
    ...
    "templates.export_one":  "Diese Vorlage einzeln exportieren",
    "templates.export_one_ok":"Vorlage „{0}\" exportiert",
    ...
    // v4.1.0 — Ausrichten / Verteilen
    "lcd.align.label":       "Ausrichten:",
    "lcd.align.tooltip":     "Selektierte Widgets aneinander ausrichten",
    "lcd.align.left":        "Linksbündig",
    "lcd.align.right":       "Rechtsbündig",
    "lcd.align.hcenter":     "Horizontal mittig",
    "lcd.align.top":         "Oben bündig",
    "lcd.align.bottom":      "Unten bündig",
    "lcd.align.vcenter":     "Vertikal mittig",
    "lcd.dist.h":            "Horizontal gleichmäßig verteilen",
    "lcd.dist.v":            "Vertikal gleichmäßig verteilen",
    ...
    "share.export_link":     "🔗 Teilen-Link",
    "share.import":          "📥 Token laden",
    "share.toast_link_ok":   "Teilen-Link in Zwischenablage kopiert ({0} Zeichen)",
    "share.toast_link_manual":"Teilen-Link erzeugt — bitte manuell aus dem Feld kopieren",
    "share.toast_link_err":  "Link-Erzeugung fehlgeschlagen",
    "share.toast_link_loaded":"Konfiguration aus Link geladen",
    "share.confirm_link_replace":"Ein Teilen-Link liegt in der URL. Konfiguration daraus laden? (Erzeugt am: {0})",
    ...
    // Rule sets (v5.0.0)
    "ruleset.title":         "::: REGELSÄTZE",
    "ruleset.help":          "Jeder Regelsatz ist ein eigener WENN/DANN/SONST-Block — sie laufen alle nacheinander im Skript. Klick auf einen Tab, um ihn zu bearbeiten.",
    "ruleset.name_default":  "Regel {0}",
    "ruleset.add":           "+ Neue Regel",
    "ruleset.add_title":     "Neuen Regelsatz hinzufügen",
    "ruleset.rename_title":  "Regelsatz umbenennen",
    "ruleset.remove_title":  "Regelsatz löschen",
    "ruleset.rename_q":      "Neuer Name für den Regelsatz:",
    "ruleset.remove_q":      "Regelsatz „{0}\" wirklich löschen? Bedingungen und Aktionen dieser Regel gehen verloren.",
    "ruleset.remove_btn":    "Löschen",
    "ruleset.cant_remove_last": "Mindestens ein Regelsatz muss übrigbleiben.",
    "desc.rule.prefix":      "Regel „{0}\":",
    "gen.cmt.rule_header":   "Regel {0}: {1}",
    ...
    "validate.duplicate":    "Dieser Name wird auch für einen anderen Block-Typ verwendet — Tippfehler?",
  ...
  en: {
    ...
    "exec.refresh_interval": "Aggregator refresh every N ticks",
    "exec.refresh_interval.help": "Aggregator lists (for 'All blocks of type' and LCD aggregator widgets) refresh every tick by default. Higher = more economical, but new blocks are detected up to N ticks later. The SE wiki recommends 100+.",
    "exec.chunk_size":       "Blocks per tick (coroutine chunk)",
    "exec.chunk_size.help":  "How many blocks are processed per tick in aggregator coroutine mode. Default 50. Smaller = more ticks to finish, but lower pressure on the tick budget.",
    "cond.paren_open":       "( open",
    "cond.paren_close":      ") close",
    "cond.paren_open.title": "Open parenthesis — before this condition",
    "cond.paren_close.title":"Close parenthesis — after this condition",
    ...
    "templates.export_one":  "Export this template",
    "templates.export_one_ok":"Template \"{0}\" exported",
    ...
    // v4.1.0 — align / distribute
    "lcd.align.label":       "Align:",
    "lcd.align.tooltip":     "Align selected widgets to each other",
    "lcd.align.left":        "Align left",
    "lcd.align.right":       "Align right",
    "lcd.align.hcenter":     "Center horizontally",
    "lcd.align.top":         "Align top",
    "lcd.align.bottom":      "Align bottom",
    "lcd.align.vcenter":     "Center vertically",
    "lcd.dist.h":            "Distribute horizontally",
    "lcd.dist.v":            "Distribute vertically",
    ...
    "share.export_link":     "🔗 Share link",
    "share.import":          "📥 Load token",
    "share.toast_link_ok":   "Share link copied to clipboard ({0} chars)",
    "share.toast_link_manual":"Share link created — please copy manually from the field",
    "share.toast_link_err":  "Link creation failed",
    "share.toast_link_loaded":"Configuration loaded from link",
    "share.confirm_link_replace":"A share link is in the URL. Load configuration from it? (Created: {0})",
    ...
    "ruleset.title":         "::: RULE SETS",
    "ruleset.help":          "Each rule set is its own IF/THEN/ELSE block — they all run sequentially in the script. Click a tab to edit it.",
    "ruleset.name_default":  "Rule {0}",
    "ruleset.add":           "+ New rule",
    "ruleset.add_title":     "Add a new rule set",
    "ruleset.rename_title":  "Rename rule set",
    "ruleset.remove_title":  "Delete rule set",
    "ruleset.rename_q":      "New name for the rule set:",
    "ruleset.remove_q":      "Really delete rule set \"{0}\"? Conditions and actions of this rule will be lost.",
    "ruleset.remove_btn":    "Delete",
    "ruleset.cant_remove_last": "At least one rule set must remain.",
    "desc.rule.prefix":      "Rule \"{0}\":",
    "gen.cmt.rule_header":   "Rule {0}: {1}",
    ...
    "validate.duplicate":    "This name is also used for a different block type — typo?",
